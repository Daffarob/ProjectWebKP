...
<head>
    <meta charset="UTF-8">
    <title>Pilih Jenis Mesin | Samafitro</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gradient-to-br from-gray-100 to-gray-300 text-gray-900 min-h-screen">
    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="#" class="text-gray-600 hover:text-black"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 3h18M3 3v18M3 21h18" /></svg></a>
                <a href="#" class="text-gray-600 hover:text-black"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M5 12h14M12 5l7 7-7 7" /></svg></a>
            </div>
        </div>
    </header>
    ...
    <main class="max-w-4xl mx-auto py-20 text-center">
        ...
        <!-- Pilih Button -->
        <div class="mt-10">
            <a id="selectBtn" href="#" class="bg-gray-800 text-white px-6 py-2 rounded hover:bg-gray-700 transition">
                Pilih Jenis Mesin
            </a>
        </div>
    </main>
    ...
    <script>
        ...
        function updateCarousel() {
            ...
            document.getElementById('selectBtn').href = `/katalog-produk/${encodeURIComponent(selectedText)}`;
        }
