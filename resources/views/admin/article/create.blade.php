...
<body class="bg-gradient-to-b from-gray-900 to-gray-800 text-white font-sans min-h-screen flex flex-col">
    ...
    <main class="flex-grow">
        <div class="max-w-3xl mx-auto my-10 p-8 rounded-xl shadow-lg bg-gradient-to-br from-gray-800 via-gray-900 to-black">
            ...
            <h2 class="text-2xl font-bold mb-6 text-white">Tambah Artikel Baru</h2>
            ...
            <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="content" id="content" rows="6" placeholder="Tulis isi artikel..." required></textarea>
                </div>

                <div class="mb-5">
                    <label for="year" class="block mb-2 font-semibold">Tahun</label>
                    <input type="text" name="year" id="year" placeholder="Contoh: 2025" required>
                </div>

                <div class="mb-5">
                    <label for="image" class="block mb-2 font-semibold">Gambar</label>
