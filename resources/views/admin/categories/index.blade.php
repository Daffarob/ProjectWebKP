...
<body>
    ...
    <main class="max-w-4xl mx-auto py-20 text-center">
        ...
        <!-- Pilih Button -->
        <div class="mt-10">
            <a id="selectBtn" href="admin/categories/{id}" class="bg-gray-800 text-white px-6 py-2 rounded hover:bg-gray-700 transition">
                Pilih Jenis Mesin
            </a>
        </div>
        <div class="mt-5">
    ...
    <script>
        ...
        function updateCarousel() {
            ...
            document.getElementById('selectBtn').href = `/admin/categories/${encodeURIComponent(selectedText)}`;
        }
